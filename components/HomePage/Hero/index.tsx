  ...
  return (
    <HeroStyles.Root>
      ...
      <HeroStyles.Background>
        <source
          srcSet={require('../../../public/images/hero-bg.jpg?webp&size=1400')}
          type="image/webp"
        />
        <source
          srcSet={require('../../../public/images/hero-bg.jpg?size=1400')}
          type="image/jpeg"
        />
        <img src={require('../../../public/images/hero-bg.jpg?size=1400')} />
      </HeroStyles.Background>
    </HeroStyles.Root>
  );
};
